...
Treatment (inclusion) is a significant predictor of absenteeism (CA) as are the covariates generally associated with higher absenteeism. These same covariates are also predictive of the treatment, meaning that these covariates are confounders.
...
Matching yields a statistically significant treatment effect, improving our confidence in the causal effect of inclusion.
